...
const ExperienceCard = ({exp}) => (
  <VerticalTimelineElement
    ...
    /* icon={
      <div className="flex justify-center items-center w-full h-full">
        <img scr={exp.icon} alt={exp.company_name}
  ...
  >
    ...
    <ul className="mt-5 list-disc ml-5 space-y-2">
      {exp.points.map((e,index)=>(
        <li className="text-white-100 text-[14px] pl-1 traching-wider" key={index}>
          {e}
        </li>
      ))}
    </ul>
...
const Experience = () => (
    ...
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className={styles.sectionHeadText}>Small and medium enterprises</h2>
      </motion.div>
